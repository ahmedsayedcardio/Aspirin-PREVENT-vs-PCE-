This repository has a Quarto file containing the R code necessary to reproduce an analysis estimating the clinical implications of using the Predicting Risk of Cardiovascular Disease Events (PREVENT)
